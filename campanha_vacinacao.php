 ...
 */
    ...
    class campanha_vacinacao_animalPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_campanha_vacinacao_animal_cpf_proprietario_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('cpf_proprietario', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_campanha_vacinacao_animal_cpf_proprietario_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_campanha_vacinacao_animal_id_campanha_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_campanha', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_campanha_vacinacao_animal_id_campanha_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_campanha_vacinacao_animal_id_vacina_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_vacina', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_campanha_vacinacao_animal_id_vacina_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Cpf Proprietario', 'cpf_proprietario', 'cpf_proprietario_nome', 'edit_campanha_vacinacao_animal_cpf_proprietario_search', $editor, $this->dataset, $lookupDataset, 'cpf_proprietario', 'nome', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Id Campanha', 'id_campanha', 'id_campanha_nome_campanha', 'edit_campanha_vacinacao_animal_id_campanha_search', $editor, $this->dataset, $lookupDataset, 'id_campanha', 'nome_campanha', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Id Vacina', 'id_vacina', 'id_vacina_nome_vacina', 'edit_campanha_vacinacao_animal_id_vacina_search', $editor, $this->dataset, $lookupDataset, 'id_vacina', 'nome_vacina', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nome', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Cpf Proprietario', 'cpf_proprietario', 'cpf_proprietario_nome', 'multi_edit_campanha_vacinacao_animal_cpf_proprietario_search', $editor, $this->dataset, $lookupDataset, 'cpf_proprietario', 'nome', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Campanha', 'id_campanha', 'id_campanha_nome_campanha', 'multi_edit_campanha_vacinacao_animal_id_campanha_search', $editor, $this->dataset, $lookupDataset, 'id_campanha', 'nome_campanha', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Vacina', 'id_vacina', 'id_vacina_nome_vacina', 'multi_edit_campanha_vacinacao_animal_id_vacina_search', $editor, $this->dataset, $lookupDataset, 'id_vacina', 'nome_vacina', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nome', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Cpf Proprietario', 'cpf_proprietario', 'cpf_proprietario_nome', 'insert_campanha_vacinacao_animal_cpf_proprietario_search', $editor, $this->dataset, $lookupDataset, 'cpf_proprietario', 'nome', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Campanha', 'id_campanha', 'id_campanha_nome_campanha', 'insert_campanha_vacinacao_animal_id_campanha_search', $editor, $this->dataset, $lookupDataset, 'id_campanha', 'nome_campanha', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Id Vacina', 'id_vacina', 'id_vacina_nome_vacina', 'insert_campanha_vacinacao_animal_id_vacina_search', $editor, $this->dataset, $lookupDataset, 'id_vacina', 'nome_vacina', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('nome', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_campanha_vacinacao_animal_cpf_proprietario_search', 'cpf_proprietario', 'nome', null, 20);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_campanha_vacinacao_animal_id_campanha_search', 'id_campanha', 'nome_campanha', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_campanha_vacinacao_animal_id_vacina_search', 'id_vacina', 'nome_vacina', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_campanha_vacinacao_animal_cpf_proprietario_search', 'cpf_proprietario', 'nome', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_campanha_vacinacao_animal_id_campanha_search', 'id_campanha', 'nome_campanha', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_campanha_vacinacao_animal_id_vacina_search', 'id_vacina', 'nome_vacina', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_campanha_vacinacao_animal_cpf_proprietario_search', 'cpf_proprietario', 'nome', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_campanha_vacinacao_animal_id_campanha_search', 'id_campanha', 'nome_campanha', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_campanha_vacinacao_animal_id_vacina_search', 'id_vacina', 'nome_vacina', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_campanha_vacinacao_animal_cpf_proprietario_search', 'cpf_proprietario', 'nome', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_campanha', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_campanha_vacinacao_animal_id_campanha_search', 'id_campanha', 'nome_campanha', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_campanha_vacinacao_animal_id_vacina_search', 'id_vacina', 'nome_vacina', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class campanha_vacinacaoPage extends Page
    {
        protected function DoBeforeCreate()
        {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'nome_campanha', 'nome_campanha', 'Nome da Campanha (nome - ano)'),
                new FilterColumn($this->dataset, 'vacina', 'vacina_nome_vacina', 'Vacina'),
                new FilterColumn($this->dataset, 'data_inicio', 'data_inicio', 'Data de Inicio'),
                new FilterColumn($this->dataset, 'data_fim', 'data_fim', 'Data Fim'),
                new FilterColumn($this->dataset, 'orgao_responsavel', 'orgao_responsavel', 'Orgão Responsável pela Campanha')
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_campanha_vacinacao_vacina_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('vacina', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_campanha_vacinacao_vacina_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('campanha_vacinacao.animal')->HasViewGrant() && $withDetails)
            {
            //
            // View column for campanha_vacinacao_animal detail
            //
            $column = new DetailColumn(array('id_campanha'), 'campanha_vacinacao.animal', 'campanha_vacinacao_animal_handler', $this->dataset, 'Animal');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            // View column for nome_campanha field
            //
            $column = new TextViewColumn('nome_campanha', 'nome_campanha', 'Nome da Campanha (nome - ano)', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            ...
            //
            $column = new DateTimeViewColumn('data_inicio', 'data_inicio', 'Data de Inicio', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDateTimeFormat('Y-m-d');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            ...
            //
            $column = new TextViewColumn('orgao_responsavel', 'orgao_responsavel', 'Orgão Responsável pela Campanha', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('Nome da Campanha (nome - ano)', 'nome_campanha', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Vacina', 'vacina', 'vacina_nome_vacina', 'edit_campanha_vacinacao_vacina_search', $editor, $this->dataset, $lookupDataset, 'id_vacina', 'nome_vacina', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new CustomEditColumn('Data de Inicio', 'data_inicio', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('Orgão Responsável pela Campanha', 'orgao_responsavel', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Vacina', 'vacina', 'vacina_nome_vacina', 'multi_edit_campanha_vacinacao_vacina_search', $editor, $this->dataset, $lookupDataset, 'id_vacina', 'nome_vacina', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Vacina', 'vacina', 'vacina_nome_vacina', 'insert_campanha_vacinacao_vacina_search', $editor, $this->dataset, $lookupDataset, 'id_vacina', 'nome_vacina', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new campanha_vacinacao_animalPage('campanha_vacinacao_animal', $this, array('id_campanha'), array('id_campanha'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('campanha_vacinacao.animal'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('campanha_vacinacao.animal'));
            $detailPage->SetHttpHandlerName('campanha_vacinacao_animal_handler');
            $handler = new PageHTTPHandler('campanha_vacinacao_animal_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_campanha_vacinacao_vacina_search', 'id_vacina', 'nome_vacina', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_campanha_vacinacao_vacina_search', 'id_vacina', 'nome_vacina', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_campanha_vacinacao_vacina_search', 'id_vacina', 'nome_vacina', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('nome_vacina', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_campanha_vacinacao_vacina_search', 'id_vacina', 'nome_vacina', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new campanha_vacinacaoPage("campanha_vacinacao", "campanha_vacinacao.php", GetCurrentUserPermissionsForPage("campanha_vacinacao"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("campanha_vacinacao"));
